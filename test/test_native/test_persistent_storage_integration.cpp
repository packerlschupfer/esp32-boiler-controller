...
void test_save_and_load() {
    ...
    // Set up parameters
    settings->heating_target_temperature = tempFromFloat(22.5f);
    ...
    // Modify values
    settings->heating_target_temperature = tempFromFloat(19.0f);
    ...
    TEST_ASSERT_EQUAL_INT16(tempFromFloat(22.5f), settings->heating_target_temperature);
...
void test_persistence_across_restarts() {
    ...
    settings->heating_target_temperature = tempFromFloat(23.0f);
    settings->pid_kp = 2.5f;
    settings->pid_ki = 0.15f;
    ...
    // Verify persistence
    TEST_ASSERT_EQUAL_INT16(tempFromFloat(23.0f), settings->heating_target_temperature);
    TEST_ASSERT_EQUAL_FLOAT(2.5f, settings->pid_kp);
    TEST_ASSERT_EQUAL_FLOAT(0.15f, settings->pid_ki);
