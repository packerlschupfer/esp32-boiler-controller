...
void TaskInitializer::initializePumpTasks(SystemInitializer* initializer) {
    ...
    // Pumps are controlled exclusively via BurnerSystemController batch commands
    // (atomic pump+burner activation in single Modbus transaction)
    // PumpCoordinator handles motor protection and state tracking
