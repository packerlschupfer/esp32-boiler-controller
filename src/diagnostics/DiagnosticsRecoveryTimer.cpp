 ...
 * 
 * @param delayMs Delay in milliseconds before restoration (default from SystemConstants)
 * @return true if timer was created successfully
 */
bool scheduleDiagnosticsRecovery(uint32_t delayMs = SystemConstants::Diagnostics::RECOVERY_DELAY_MS) {
