...
struct SystemSettings {
    ...
    Temperature_t wHeaterConfTempChargeDelta; // Desired differential between boiler water and circulating water temperatures (tenths °C)
    ...
    bool useWeatherCompensatedControl = false;        // Default OFF — requires working outside temp sensor
    ...
    SystemSettings(
        ...
        Temperature_t wHeaterConfTempChargeDelta = tempFromFloat(10.0f),
