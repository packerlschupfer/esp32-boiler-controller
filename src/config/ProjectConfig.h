...
// Stack sizes (in bytes) - Three-tier optimization based on logging mode
    ...
    #define STACK_SIZE_RELAY_CONTROL_TASK    3584  // Dec 2025: was 4096, had 2032 free
    ...
    #define STACK_SIZE_CONTROL_TASK          3072  // Restored - was showing 376 bytes free
    ...
    // #define STACK_SIZE_BLE_SENSOR_TASK       4096  // BLE removed
    #define STACK_SIZE_BURNER_CONTROL_TASK   3584  // Dec 2025: was 3072, had 768 free
...
// ==========================
#define PROJECT_MB8ART_MIN_REQUEST_INTERVAL_MS 50    // Minimum 50ms between requests
#define MB8ART_REQUEST_TIMEOUT_MS 500        // 500ms timeout for Modbus requests
#define MB8ART_INTER_REQUEST_DELAY_MS 5     // 5ms delay between consecutive requests
#define MB8ART_RETRY_COUNT 3                 // 3 retries for failed requests
...
#define RYN4_MIN_REQUEST_INTERVAL_MS 50       // Minimum 50ms between requests
...
#define RYN4_INTER_REQUEST_DELAY_MS 5         // 5ms delay between consecutive requests
#define RYN4_INTER_COMMAND_DELAY_MS 50        // 50ms delay between consecutive commands
