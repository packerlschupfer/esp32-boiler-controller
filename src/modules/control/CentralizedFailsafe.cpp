...
void CentralizedFailsafe::emergencyStop(const char* reason) {
    ...
    RelayControlTask::setRelayState(RelayFunction::BURNER_ENABLE, false);
    RelayControlTask::setRelayState(RelayFunction::POWER_SELECT, false);
    RelayControlTask::setRelayState(RelayFunction::WATER_MODE, false);
