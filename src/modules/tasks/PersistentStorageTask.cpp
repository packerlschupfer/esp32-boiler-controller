...
void PersistentStorageTask(void* pvParameters) {
    ...
    storage->setOnChange("wheater/tempLimitLow", floatParamCallback);
    storage->setOnChange("wheater/tempLimitHigh", floatParamCallback);
    storage->setOnChange("wheater/tempChargeDelta", floatParamCallback);
    storage->setOnChange("wheater/tempSafeLimitHigh", floatParamCallback);
    storage->setOnChange("wheater/tempSafeLimitLow", floatParamCallback);
    // Heating parameters (floats)
    storage->setOnChange("heating/targetTemp", floatParamCallback);
    storage->setOnChange("heating/curveShift", floatParamCallback);
    storage->setOnChange("heating/curveCoeff", floatParamCallback);
    storage->setOnChange("heating/burnerLowLimit", floatParamCallback);
    storage->setOnChange("heating/highLimit", floatParamCallback);
    storage->setOnChange("heating/hysteresis", floatParamCallback);
