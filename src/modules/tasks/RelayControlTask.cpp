...
void RelayControlTask::processRelayRequests() {
    ...
    if (requestBits & SystemEvents::RelayRequest::HEATING_PUMP_ON) {
        ...
        if (setRelayState(RelayIndex::toPhysical(RelayIndex::HEATING_PUMP), true)) {
    ...
    if (requestBits & SystemEvents::RelayRequest::HEATING_PUMP_OFF) {
        ...
        if (setRelayState(RelayIndex::toPhysical(RelayIndex::HEATING_PUMP), false)) {
    ...
    if (requestBits & SystemEvents::RelayRequest::WATER_PUMP_ON) {
        ...
        if (setRelayState(RelayIndex::toPhysical(RelayIndex::WATER_PUMP), true)) {
    ...
    if (requestBits & SystemEvents::RelayRequest::WATER_PUMP_OFF) {
        ...
        if (setRelayState(RelayIndex::toPhysical(RelayIndex::WATER_PUMP), false)) {
    ...
    if (requestBits & SystemEvents::RelayRequest::BURNER_ENABLE) {
        ...
        if (setRelayState(RelayIndex::toPhysical(RelayIndex::BURNER_ENABLE), true)) {
    ...
    if (requestBits & SystemEvents::RelayRequest::BURNER_DISABLE) {
        ...
        if (setRelayState(RelayIndex::toPhysical(RelayIndex::BURNER_ENABLE), false)) {
    ...
    if (requestBits & SystemEvents::RelayRequest::POWER_HALF) {
        ...
        if (setRelayState(RelayIndex::toPhysical(RelayIndex::POWER_BOOST), false)) {
    ...
    if (requestBits & SystemEvents::RelayRequest::POWER_FULL) {
        ...
        if (setRelayState(RelayIndex::toPhysical(RelayIndex::POWER_BOOST), true)) {
    ...
    if (requestBits & SystemEvents::RelayRequest::WATER_MODE_ON) {
        ...
        if (setRelayState(RelayIndex::toPhysical(RelayIndex::WATER_MODE), true)) {
    ...
    if (requestBits & SystemEvents::RelayRequest::WATER_MODE_OFF) {
        ...
        if (setRelayState(RelayIndex::toPhysical(RelayIndex::WATER_MODE), false)) {
