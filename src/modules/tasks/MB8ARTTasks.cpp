 ...
 */
// Helper function to get temperature offset for a given channel
static Temperature_t getChannelOffset(size_t channel) {
    const auto& settings = SRP::getSystemSettings();
    switch (channel) {
        case 0: return settings.boilerOutputOffset;
        case 1: return settings.boilerReturnOffset;
        case 2: return settings.waterTankOffset;
        case 3: return settings.waterOutputOffset;
        case 4: return settings.waterReturnOffset;
        case 5: return settings.heatingReturnOffset;
        case 6: return settings.outsideTempOffset;
        default: return 0;
    }
}
