...
| 2 | `PRIORITY_WATER` | Water has priority |
...
- `ALL_BITS`: HEATING | WATER | PRIORITY_WATER | POWER_LOW | POWER_HIGH | TEMPERATURE_MASK | CHANGED | HEATING_CHANGED | WATER_CHANGED
