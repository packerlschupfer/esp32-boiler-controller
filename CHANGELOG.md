...
- Sensor staleness detection (15s threshold blocks burner operation)
- Equipment protection (30s pump motor protection, 2min burner anti-flapping)
...
### Dependencies
All custom libraries published separately under MIT license:
