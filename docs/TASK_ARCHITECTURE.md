...
**Project**: ESPlan Boiler Controller
**Last Updated**: December 4, 2025
**Context**: 21 rounds of deep code analysis and optimization

---

## Overview

The ESP32 Boiler Controller uses **16 active FreeRTOS tasks** managing boiler control, sensors, communication, and monitoring. The architecture is fully **event-driven** with zero polling loops for optimal power efficiency and responsive safety systems.
...
- **Burner Request Event Group** (waits): `HEATING`, `WATER`, `PRIORITY_WATER`, `CHANGE_EVENT_BITS`, `TEMPERATURE_MASK`
...
- **Burner Request Event Group** (waits/checks): `WATER`, `PRIORITY_WATER`
...
#### RYN4ProcessingTask
**Purpose**: Process Modbus packets from RYN4 relay controller (stays alive for library queue)
...
### Priority 2 (Non-Critical Communication)
...
| System State Event Group | All control tasks | System-wide enable states |
